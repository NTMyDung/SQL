...
INSERT INTO KHOA (MAKHOA,TENKHOA, NGTLAP) VALUES('KTMT','Ky thuat may tinh','20/12/2005')
...
--Cau 11--
ALTER TABLE HOCVIEN
ADD CONSTRAINT CHECK_T CHECK( (DATEDIFF(yyyy,NGSINH, GETDATE())>18)
							OR(DATEDIFF(yyyy,NGSINH, GETDATE())=18 AND month(GETDATE())> month(NGSINH))
							OR(DATEDIFF(yyyy,NGSINH, GETDATE())=18 AND month(GETDATE())= month(NGSINH) AND day(GETDATE())<=day(NGSINH)))
--Cau 12--
...
FROM HOCVIEN HV
	JOIN LOP LP ON HV.MALOP=LP.MALOP
WHERE HV.MAHV=LP.TRGLOP
--2--
SELECT KQ.MAHV, HV.HO, HV.TEN, KQ.LANTHI, KQ.DIEM
FROM KETQUATHI KQ
	JOIN HOCVIEN HV ON KQ.MAHV=HV.MAHV
WHERE KQ.MAMH='CTRR' AND HV.MALOP='K12'
ORDER BY TEN ASC, HO ASC
--3--
SELECT KQ.MAHV, HV.HO, HV.TEN, KQ.MAMH
FROM KETQUATHI KQ
	JOIN HOCVIEN HV ON KQ.MAHV=HV.MAHV
WHERE KQ.LANTHI='1' AND KQ.KQUA='Dat'
--4--
SELECT KQ.MAHV, HV.HO, HV.TEN
FROM KETQUATHI KQ
	JOIN HOCVIEN HV ON KQ.MAHV=HV.MAHV
WHERE KQ.MAMH='CTRR' AND HV.MALOP='K11' AND KQ.LANTHI='1' AND KQ.KQUA='Khong Dat'
--5--
	SELECT KQ.MAHV, HV.HO, HV.TEN
...
INTERSECT
	SELECT KQ.MAHV, HV.HO, HV.TEN
	FROM KETQUATHI KQ JOIN HOCVIEN HV ON KQ.MAHV=HV.MAHV
	WHERE KQ.MAMH='CTRR' AND KQ.LANTHI='2' AND KQ.KQUA='Khong Dat'
INTERSECT
	SELECT KQ.MAHV, HV.HO, HV.TEN
	FROM KETQUATHI KQ JOIN HOCVIEN HV ON KQ.MAHV=HV.MAHV
	WHERE KQ.MAMH='CTRR' AND KQ.LANTHI='3' AND KQ.KQUA='Khong Dat'
